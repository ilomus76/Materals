...
<head>
    ...
    <link rel="stylesheet" href="../css/4_2_liked_contents.css">
...
<div id="wrap">
    ...
    <main>
        ...
        <div class="search_bar">
            ...
            <h1>내가 좋아한 맛식당</h1>
           <form id="list_search" action="./4_2_liked_contents.php" method="get">
                <input 
                    id="search_keyword"
                    type="text" 
                    name="keyword" 
        ...
        <div id="contents_menu">
            ...
            <?php if($count == 0){ ?>
                ...
                <?php }else{ ?>
                    <p class="empty_text">아직 좋아요한 맛식당이 없습니다.</p>
                <?php } ?>
            <?php } ?>
        </div>
